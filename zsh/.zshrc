...
bindkey '^[[1;5D' backward-word # crt + <-
bindkey '^[[1;5C' forward-word # crt + ->
...
alias ll='eza --icons=always --color=always -l --group-directories-first'
alias lla='eza --icons=always --color=always -la --group-directories-first'
alias tree='eza -T'
